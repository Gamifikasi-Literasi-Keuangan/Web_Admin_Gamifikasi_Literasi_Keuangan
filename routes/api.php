...
Route::get('/card/risk/{id}', [CardController::class, 'getRiskCard']);
Route::get('/card/chance/{id}', [CardController::class, 'getChanceCard']);
Route::get('/card/quiz/{id}', [CardController::class, 'getQuizCard']);
Route::post('/card/quiz/submit', [CardController::class, 'submitQuiz']);
